...
const String apiKey = "3pZgQFR9FsWljO9R2BtxkPITsz7fN43l";
const String baseUrl = "https://api.on-demand.io/chat/v1";

String externalUserId = "<your_external_user_id>";
const String query = "Perfor m OCR on the input image";
const String responseMode = "stream"; // Now dynamic
final List<String> agentIds = ["agent-1712327325","agent-1768726184"]; // Dynamic list from PluginIds
const String endpointId = "predefined-gemini-3.0-pro";
const String reasoningMode = "grok-4-fast";
const String fulfillmentPrompt = "Perform OCR on the input image";
